<?php  
	class controller_product_sale{
		...
		public function __construct(){
			...
			$total = $this->model->num_rows("select c_name from tbl_product where c_saleproduct = 1");
			...
			//------------
			//
			$arr = $this->model->get_all("select * from tbl_product where c_saleproduct = 1 limit $from,$record_per_page");
			//load view
