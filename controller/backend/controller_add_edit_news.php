		...
		public function __construct(){
			...
			switch($act){
				...
				case "do_add":
					...
					//insert ban ghi
					$this->model->execute("insert into tbl_news(c_name,c_description,c_content,c_img,fk_category_news_id,c_hotnews,c_date) values('$c_name','$c_description','$c_content','$c_img',$fk_category_news_id,$c_hotnews,$c_date)");
					header("location:admin.php?controller=news");
				break;
			}
			//load view
