				...
				<?php foreach($arr as $rows): ?>
					<tr>
						...
						<td style="text-align: center;">
							<a href="admin.php?controller=add_edit_slide&act=edit&id=<?php echo $rows->pk_slide_id; ?>"><img src="public/frontend/images/icon-edit.jpg" style="width:25px;" />Edit</a>&nbsp;&nbsp;
							<a onclick="return window.confirm('Are you sure?');" href="admin.php?controller=add_edit_slide&act=delete&id=<?php echo $rows->pk_slide_id; ?>"><img src="public/frontend/images/icon-remove.jpg" style="width:25px;" />Delete</a>
						</td>
					</tr>
				<?php endforeach; ?>
				</table>
