						...
						<form method="post" action="">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-9"><input type="email" name="c_email" required class="form-control" placeholder="Email Address"></div>
								</div>
							</div>
							<!-- end form group -->
							<!-- form group -->
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-9"><input type="password" name="c_password" required class="form-control" placeholder="Password"></div>
								</div>
							</div>
							<!-- end form group -->
							<!-- form group -->
