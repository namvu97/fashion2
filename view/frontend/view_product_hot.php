	...
	<header class="woocommerce-products-header">
		...
		<h1 class="woocommerce-products-header__title page-title">Sản phẩm bán chạy				
...
<div class="wp-pagenavi">
	<ul class="page-numbers">
		<?php for($i = 1; $i<=$num_page; $i++): ?>
			<li><a class="page-numbers" href="index.php?controller=product_hot&id=<?php echo $id; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
		<?php endfor; ?>
	</ul>
</div>