	...
	<header class="woocommerce-products-header">
		...
		<h1 class="woocommerce-products-header__title page-title" style="text-align:center;">Danh mục sản phẩm : <?php 
...
<div class="wp-pagenavi">
	<ul class="page-numbers">
		<?php for($i = 1; $i<=$num_page; $i++): ?>
			<li><a class="page-numbers" href="index.php?controller=product_category&id=<?php echo $id; ?>&id1=<?php echo $id1; ?>&id2=<?php echo $id2; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
		<?php endfor; ?>
	</ul>
</div>