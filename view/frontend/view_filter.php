	...
	<header class="woocommerce-products-header">
		...
		<h1 class="woocommerce-products-header__title page-title">
			Sản phẩm có mức giá (<?php echo $min;?><?php if($max<7000000) echo "-"  ?><?php if($max>=7000000) echo "+" ?><?php if($max<7000000) echo $max; ?>)		
...
<div class="wp-pagenavi">
	<ul class="page-numbers">
		<?php for($i = 1; $i<=$num_page; $i++): ?>
			<li><a class="page-numbers" href="index.php?controller=filter&min=<?php echo $min; ?>&max=<?php echo $max; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
		<?php endfor; ?>
	</ul>
</div>